"""
Idaho Procurement scraper — Division of Purchasing

Source: https://purchasing.idaho.gov/current-bids/
"""
import time, random
...
class IdahoProcurementScraper(BaseScraper):
    SEARCH_URL = "https://purchasing.idaho.gov/current-bids/"
    def __init__(self):
        super().__init__("Idaho Purchasing")
    def scrape(self):
        ...
        try:
            ...
            logger.warning(f"Error scraping Idaho: {e}")
        self.log_summary()
